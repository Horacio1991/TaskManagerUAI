...
namespace PrincipalUI
{
    public partial class VerTareas : Form
    {
        ...
        private void CargarTareas()
        {
            ...
            // Corrijo los nombrs de las columnas
            dgvTareasAsignadas.Columns["Titulo"].HeaderText = "Título";
            dgvTareasAsignadas.Columns["Descripcion"].HeaderText = "Descripción";
            dgvTareasAsignadas.Columns["FechaSolicitada"].HeaderText = "Fecha Solicitada";
            dgvTareasAsignadas.Columns["FechaEsperadaFinalizacion"].HeaderText = "Fecha Esperada De Finalización";
            dgvTareasAsignadas.Columns["FechaFinalizacion"].HeaderText = "Fecha De Finalización";
