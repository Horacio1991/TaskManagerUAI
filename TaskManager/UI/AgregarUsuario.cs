...
namespace PrincipalUI
{
    ...
    public partial class txtModificarEmail : Form
    {
        ...
        private void CargarUsuarios()
        {
            ...
            dgvUsuarios.DataSource = usuarios; // Asumiendo que la lista tiene las propiedades correctas
        ...
        private void btnAgregar_Click_1(object sender, EventArgs e)
        {
            var usuario = new Usuario
            {
                ...
                EsAdministrador = false, // O asignar según sea necesario
                SectorId = _sectorId
            };

            try
            {
                _usuarioBll.AgregarUsuario(usuario);
